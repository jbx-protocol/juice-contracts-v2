...
In order to use the updated contracts, projects must re-instantiate their funding cycles, and re-distribute tokens to their holders. They can re-instantiate their funding cycles as follows:
