 ...
 *   --network rinkeby
 */
task('deployTokenRepresentationProxy', 'Deploys the TokenRepresentationProxy contract')
  ...
  .setAction(async (taskArgs) => {
    ...
    console.log(`Deploying `, chalk.magenta(contract), `with the following params: `);
