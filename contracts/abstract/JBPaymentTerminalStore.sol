...
*/
abstract contract JBPaymentTerminalStore is IJBPaymentTerminalStore {
  ...
  */
  function targetDecimals() public pure virtual override returns (uint256);
