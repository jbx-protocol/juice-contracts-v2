...
contract JBETHPaymentTerminalStore {
  ...
  */
    function currentTotalOverflowOf(uint256 _projectId)
        external
        view
        returns (uint256)
    {
            ...
            (weight, memo, _delegate, _delegateMetadata) = fundingCycle
                ...
                .payParams(
                    JBPayParamsData(
                        ...
                        address(
                            uint160(_preferClaimedTokensAndBeneficiary >> 1)
                        ),
                        _memo,
                        _delegateMetadata
                    )
  ...
  */
        ...
        returns (JBFundingCycle memory fundingCycle, uint256 distributedAmount)
    {
        ...
        usedDistributionLimitOf[_projectId][
            fundingCycle.number
        ] = _newUsedDistributionLimitOf;
  ...
  */
        ...
        )
    {
        ...
        if (fundingCycle.useDataSourceForRedeem()) {
            ...
            claimAmount = _claimableOverflowOf(
                _projectId,
                fundingCycle,
                _tokenCount
            );
  ...
  */
    function _claimableOverflowOf(
        ...
        uint256 _currentOverflow = _fundingCycle
            .shouldUseLocalBalanceForRedemptions()
        ...
        uint256 _reservedTokenAmount = directory
            ...
            .reservedTokenBalanceOf(_projectId, _fundingCycle.reservedRate());
  ...
  */
    function _overflowDuring(
        ...
        uint256 _distributionRemaining = directory
            .controllerOf(_projectId)
            .distributionLimitOf(
                _projectId,
        ...
        return
            _balanceOf <= _ethDistributionRemaining
                ? 0
                : _balanceOf - _ethDistributionRemaining;
    }
  ...
  */
    function _totalOverflowDuring(
        ...
        for (uint256 _i = 0; _i < _terminals.length; _i++) {
            _ethBalanceOf =
                _ethBalanceOf +
                _terminals[_i].ethBalanceOf(_projectId);

            // Get a reference to the amount still withdrawable during the funding cycle.
            uint256 _distributionRemaining = _terminals[_i]
