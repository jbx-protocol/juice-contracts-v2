...
export default [
  ...
  },
  {
    ...
    fn: async ({
      ...
      await executeFn({
        ...
        fn: 'pay',
        args: [expectedProjectId, preconfigTicketBeneficiary.address, randomString(), randomBool()],
        value: paymentValue1,
      });
  ...
  },
  {
    ...
    fn: async ({
      ...
      const preminePrintAmount = randomBigNumber({
        min: BigNumber.from(1),
  ...
  },
  {
    ...
    fn: ({ contracts, executeFn, randomString, local: { expectedProjectId, owner } }) =>
      executeFn({
        caller: owner,
        contract: contracts.ticketBooth,
        fn: 'issue',
