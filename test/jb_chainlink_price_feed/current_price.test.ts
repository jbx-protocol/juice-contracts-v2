...
import * as compilerOutput from '@chainlink/contracts/abi/v0.6/AggregatorV3Interface.json';
...
describe('JBChainlinkV3PriceFeed::currentPrice(...)', function () {
    ...
    beforeEach(async function () {
        ...
        aggregatorV3Contract = await deployMockContract(deployer, compilerOutput['default']);
