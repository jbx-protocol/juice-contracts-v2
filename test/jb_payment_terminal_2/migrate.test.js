...
import JBEthPaymentTerminal from '../../artifacts/contracts/JBETHPaymentTerminal/2.sol/JBETHPaymentTerminal.json';
import jbErc20PaymentTerminal from '../../artifacts/contracts/JBERC20PaymentTerminal/2.sol/JBERC20PaymentTerminal.json';
...
describe('JBPayoutRedemptionPaymentTerminal::migrate(...)', function () {
  ...
  async function setup() {
    ...
    let jbErc20TerminalFactory = await ethers.getContractFactory(
      'contracts/JBERC20PaymentTerminal/2.sol:JBERC20PaymentTerminal',
      deployer,
    );
